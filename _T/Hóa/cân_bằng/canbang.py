...
elementList=[]
elementMatrix=[]
print("Lưu ý: Phải nhập đúng nếu không sẽ bị sai.")
print("Nhập Phản Ứng (như là H2 + O2)")
reactants=input("Phản Ứng: ")
print("Nhập Sản Phẩm (như H2O ,phải đúng theo phản ứng, lật ra trang 55,56 để tham khảo.)")
products=input("Sản Phẩm: ")
